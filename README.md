...
* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://gitproxy.click/https://raw.githubusercontent.com/KANIKIG/Multi-EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh`  
